  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Experience Seamless Healthcare with Telemedicine: Revolutionizing Patient-Doctor Interactions for Optimum Health Outcomes."
        />
      </Head>
      <HomeLayout>
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Experience Seamless Healthcare with Telemedicine: Revolutionizing Patient-Doctor Interactions for Optimum Health Outcomes.`}
            </Text>
            <Box
